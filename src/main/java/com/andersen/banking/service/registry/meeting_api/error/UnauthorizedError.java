...
import static com.andersen.banking.service.registry.meeting_api.utils.OpenApiConstants.EXAMPLE_ERROR_UNAUTHORIZED;
import static com.andersen.banking.service.registry.meeting_api.utils.OpenApiConstants.HTTP_UNAUTHORIZED;
...
public class UnauthorizedError {
    ...
    @Schema(description = DESCRIPTION_ERROR_DESCRIPTION,
            example = EXAMPLE_ERROR_UNAUTHORIZED, defaultValue = EXAMPLE_ERROR_UNAUTHORIZED)
    @JsonProperty("message")
    private String message;

    @Schema(description = DESCRIPTION_ERROR_CODE, example = HTTP_UNAUTHORIZED, defaultValue = HTTP_UNAUTHORIZED)
