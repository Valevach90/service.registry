...
-- INSERT INTO information_service.country (created_date, created_by, last_modified_date, last_modified_by, deleted, country_name) VALUES (now(), current_user, now(), current_user, false, 'Croatia');
...
-- INSERT INTO information_service.city (created_date, created_by, last_modified_date, last_modified_by, deleted, country_id, city_name) VALUES (now(), current_user, now(), current_user, false, 1, 'Berlin');
-- INSERT INTO information_service.city (created_date, created_by, last_modified_date, last_modified_by, deleted, country_id, city_name) VALUES (now(), current_user, now(), current_user, false, 1, 'Hamburg');
-- INSERT INTO information_service.city (created_date, created_by, last_modified_date, last_modified_by, deleted, country_id, city_name) VALUES (now(), current_user, now(), current_user, false, 1, 'Dresden');
-- INSERT INTO information_service.city (created_date, created_by, last_modified_date, last_modified_by, deleted, country_id, city_name) VALUES (now(), current_user, now(), current_user, false, 2, 'Paris');
-- INSERT INTO information_service.city (created_date, created_by, last_modified_date, last_modified_by, deleted, country_id, city_name) VALUES (now(), current_user, now(), current_user, false, 3, 'Vilnius');
-- INSERT INTO information_service.city (created_date, created_by, last_modified_date, last_modified_by, deleted, country_id, city_name) VALUES (now(), current_user, now(), current_user, false, 3, 'Kaunas');
-- INSERT INTO information_service.city (created_date, created_by, last_modified_date, last_modified_by, deleted, country_id, city_name) VALUES (now(), current_user, now(), current_user, false, 4, 'Sydney');
-- INSERT INTO information_service.city (created_date, created_by, last_modified_date, last_modified_by, deleted, country_id, city_name) VALUES (now(), current_user, now(), current_user, false, 5, 'Brussels');
-- INSERT INTO information_service.city (created_date, created_by, last_modified_date, last_modified_by, deleted, country_id, city_name) VALUES (now(), current_user, now(), current_user, false, 6, 'Sofia');
-- INSERT INTO information_service.city (created_date, created_by, last_modified_date, last_modified_by, deleted, country_id, city_name) VALUES (now(), current_user, now(), current_user, false, 7, 'Zagreb');
-- INSERT INTO information_service.city (created_date, created_by, last_modified_date, last_modified_by, deleted, country_id, city_name) VALUES (now(), current_user, now(), current_user, false, 8, 'Prague');
-- INSERT INTO information_service.city (created_date, created_by, last_modified_date, last_modified_by, deleted, country_id, city_name) VALUES (now(), current_user, now(), current_user, false, 9, 'Copenhagen');
-- INSERT INTO information_service.city (created_date, created_by, last_modified_date, last_modified_by, deleted, country_id, city_name) VALUES (now(), current_user, now(), current_user, false, 10, 'Tallinn');
-- INSERT INTO information_service.city (created_date, created_by, last_modified_date, last_modified_by, deleted, country_id, city_name) VALUES (now(), current_user, now(), current_user, false, 11, 'Helsinki');
-- INSERT INTO information_service.city (created_date, created_by, last_modified_date, last_modified_by, deleted, country_id, city_name) VALUES (now(), current_user, now(), current_user, false, 12, 'Athens');
-- INSERT INTO information_service.city (created_date, created_by, last_modified_date, last_modified_by, deleted, country_id, city_name) VALUES (now(), current_user, now(), current_user, false, 13, 'Budapest');
-- INSERT INTO information_service.city (created_date, created_by, last_modified_date, last_modified_by, deleted, country_id, city_name) VALUES (now(), current_user, now(), current_user, false, 14, 'Dublin');
-- INSERT INTO information_service.city (created_date, created_by, last_modified_date, last_modified_by, deleted, country_id, city_name) VALUES (now(), current_user, now(), current_user, false, 15, 'Rome');
-- INSERT INTO information_service.city (created_date, created_by, last_modified_date, last_modified_by, deleted, country_id, city_name) VALUES (now(), current_user, now(), current_user, false, 16, 'Luxembourg');
-- INSERT INTO information_service.city (created_date, created_by, last_modified_date, last_modified_by, deleted, country_id, city_name) VALUES (now(), current_user, now(), current_user, false, 17, 'Riga');
-- INSERT INTO information_service.city (created_date, created_by, last_modified_date, last_modified_by, deleted, country_id, city_name) VALUES (now(), current_user, now(), current_user, false, 18, 'Valletta');
-- INSERT INTO information_service.city (created_date, created_by, last_modified_date, last_modified_by, deleted, country_id, city_name) VALUES (now(), current_user, now(), current_user, false, 19, 'Amsterdam');
-- INSERT INTO information_service.city (created_date, created_by, last_modified_date, last_modified_by, deleted, country_id, city_name) VALUES (now(), current_user, now(), current_user, false, 20, 'Warsaw');
-- INSERT INTO information_service.city (created_date, created_by, last_modified_date, last_modified_by, deleted, country_id, city_name) VALUES (now(), current_user, now(), current_user, false, 21, 'Lisbon');
-- INSERT INTO information_service.city (created_date, created_by, last_modified_date, last_modified_by, deleted, country_id, city_name) VALUES (now(), current_user, now(), current_user, false, 22, 'Bucharest');
-- INSERT INTO information_service.city (created_date, created_by, last_modified_date, last_modified_by, deleted, country_id, city_name) VALUES (now(), current_user, now(), current_user, false, 23, 'Bratislava');
-- INSERT INTO information_service.city (created_date, created_by, last_modified_date, last_modified_by, deleted, country_id, city_name) VALUES (now(), current_user, now(), current_user, false, 24, 'Ljubljana');
-- INSERT INTO information_service.city (created_date, created_by, last_modified_date, last_modified_by, deleted, country_id, city_name) VALUES (now(), current_user, now(), current_user, false, 25, 'Madrid');
-- INSERT INTO information_service.city (created_date, created_by, last_modified_date, last_modified_by, deleted, country_id, city_name) VALUES (now(), current_user, now(), current_user, false, 26, 'Stockholm');
--
--
--
--
