...
ALTER TABLE bank_branch
    ADD CONSTRAINT FK_BANK_BRANCH_ON_CITY FOREIGN KEY (city_id) REFERENCES city (id);

ALTER TABLE bank_branch
    ADD CONSTRAINT FK_BANK_BRANCH_ON_STREET FOREIGN KEY (street_id) REFERENCES street (id);
...
ALTER TABLE time_table
    ADD CONSTRAINT FK_TIME_TABLE_ON_BRANCH FOREIGN KEY (branch_id) REFERENCES bank_branch (id);
