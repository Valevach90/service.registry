...
public class AddressDto {
    ...
    @Schema(
            description = DESCRIPTION_ZIP_CODE,
            example = EXAMPLE_ZIP_CODE,
            defaultValue = EXAMPLE_ZIP_CODE)
    ...
    @Schema(
            ...
            defaultValue = EXAMPLE_COUNTRY)
    @JsonProperty("country")
    @NotNull
    private String country;

    @Schema(
            description = DESCRIPTION_REGION,
            example = EXAMPLE_REGION,
            defaultValue = EXAMPLE_REGION)
    @JsonProperty("region")
    ...
    @Schema(
            description = DESCRIPTION_STREET,
            example = EXAMPLE_STREET,
            defaultValue = EXAMPLE_STREET)
    @JsonProperty("street")
    ...
    @Schema(
            description = DESCRIPTION_BUILDING,
            example = EXAMPLE_BUILDING,
            defaultValue = EXAMPLE_BUILDING)
