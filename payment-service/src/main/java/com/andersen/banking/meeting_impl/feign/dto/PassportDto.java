...
public class PassportDto {
    ...
    @Schema(
            description = DESCRIPTION_PASSPORT_ID,
            example = EXAMPLE_LONG,
            defaultValue = EXAMPLE_LONG)
    @JsonProperty("id")
    ...
    @Schema(
            description = DESCRIPTION_ADDRESS_ID,
            example = EXAMPLE_LONG,
            defaultValue = EXAMPLE_LONG)
    ...
    @Schema(
            description = DESCRIPTION_PASSPORT_SERIAL_NUMBER,
            example = EXAMPLE_PASSPORT_SERIAL_NUMBER,
    ...
    @Schema(
            description = DESCRIPTION_PASSPORT_CODE,
            example = EXAMPLE_PASSPORT_CODE,
            defaultValue = EXAMPLE_PASSPORT_CODE)
    ...
    @Schema(
            description = DESCRIPTION_PASSPORT_BIRTHDAY,
    ...
    @Schema(
            description = DESCRIPTION_PASSPORT_DATE_ISSUE,
            example = EXAMPLE_ISSUE_DATE,
            defaultValue = EXAMPLE_ISSUE_DATE)
    @JsonProperty("dateIssue")
    @NotNull(message = "Issue date can't be null.")
    private LocalDate dateIssue;

    @Schema(
            description = DESCRIPTION_PASSPORT_TERMINATION_DATE,
            example = EXAMPLE_TERMINATION_DATE,
    ...
    @Schema(
            description = DESCRIPTION_FIRST_NAME,
            example = EXAMPLE_FIRST_NAME,
            defaultValue = EXAMPLE_FIRST_NAME)
    @JsonProperty("firstName")
    @NotNull(message = "First name can't be null.")
    @Pattern(
            regexp = "(?=.{1,30}$)([a-zA-Z]+(?:[-]?[a-zA-Z]+))|[a-zA-Z]{1,30}",
            message = "Invalid first name.")
    private String firstName;

    @Schema(
            description = DESCRIPTION_LAST_NAME,
            example = EXAMPLE_LAST_NAME,
            defaultValue = EXAMPLE_LAST_NAME)
    ...
    @Schema(
            description = DESCRIPTION_PATRONYMIC,
            example = EXAMPLE_PATRONYMIC,
            defaultValue = EXAMPLE_PATRONYMIC)
    ...
    @Schema(
            description = DESCRIPTION_PASSPORT_DEPARTMENT_ISSUED,
            example = EXAMPLE_PASSPORT_DEPARTMENT_ISSUED,
    ...
    @Schema(
            description = DESCRIPTION_PASSPORT_BORN_PLACE,
            example = EXAMPLE_PASSPORT_BORN_PLACE,
