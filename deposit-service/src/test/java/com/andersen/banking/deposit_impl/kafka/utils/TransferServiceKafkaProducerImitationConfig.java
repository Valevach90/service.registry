...
public class TransferServiceKafkaProducerImitationConfig {
    ...
    @Bean
    public KafkaTemplate<String, RequestTransferKafkaMessage> kafkaProducerTemplateForTransferServiceImitation() {
        return new KafkaTemplate<>(producerFactoryForTransferServiceProducerImitation());
    }
}
