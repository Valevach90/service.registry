...
import com.andersen.banking.meeting_api.dto.DepositProductDescriptionCreateDto;
...
public class DepositProductRequestCreateDto {
    ...
    private List<DepositProductDescriptionCreateDto> descriptions;
}
